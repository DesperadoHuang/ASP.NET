...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:AccessDataSource ID="accessDataSource" runat="server" DataFile="~/App_Data/學生資料庫2.accdb" SelectCommand="SELECT * FROM [學生資料表]"></asp:AccessDataSource>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="accessDataSource" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="學號" DataNavigateUrlFormatString="ch9-6_8_GridView_HyperLinkField_Practice_B.aspx?studentNumber={0}" DataTextFormatString="顯示選課情況" Text="顯示選課情況" />
                </Columns>
