<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch9-6_2_GridView_Page.aspx.cs" Inherits="ch9_6_GridView" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="gridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="序號" DataSourceID="accessDataSource" ForeColor="#333333" GridLines="None" PageSize="5">
            ...
            <PagerSettings FirstPageImageUrl="~/Images/First.gif" FirstPageText="第一頁" LastPageImageUrl="~/Images/Last.gif" LastPageText="最後一頁" Mode="NextPreviousFirstLast" NextPageImageUrl="~/Images/Next.gif" NextPageText="下一頁" PreviousPageImageUrl="~/Images/Previous.gif" PreviousPageText="上一頁" />
