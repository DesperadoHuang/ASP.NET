<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch9-6_4A_GridView_Edit.aspx.cs" Inherits="ch9_6_4A_GridView" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="序號" DataSourceID="accessDataSource" ForeColor="#333333" GridLines="None" style="margin-right: 2px">
