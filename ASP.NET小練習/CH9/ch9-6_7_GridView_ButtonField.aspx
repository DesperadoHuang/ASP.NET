<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch9-6_7_GridView_ButtonField.aspx.cs" Inherits="ch9_6_7_GridView_ButtonField" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="序號" DataSourceID="accessDataSource" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand">
            ...
            <Columns>
                ...
                <asp:ButtonField ButtonType="Button" Text="總成績" />
            </Columns>
