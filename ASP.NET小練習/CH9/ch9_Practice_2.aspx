    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/result.GIF" />
                <asp:AccessDataSource ID="accessDataSourse" runat="server" DataFile="~/App_Data/MyDatabase.mdb" DeleteCommand="DELETE FROM [學生選修成績表] WHERE [學號] = ?" InsertCommand="INSERT INTO [學生選修成績表] ([學號], [姓名], [選修課程], [成績]) VALUES (?, ?, ?, ?)" SelectCommand="SELECT * FROM [學生選修成績表]" UpdateCommand="UPDATE [學生選修成績表] SET [姓名] = ?, [選修課程] = ?, [成績] = ? WHERE [學號] = ?">
                    <DeleteParameters>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="學號" DataSourceID="accessDataSourse" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        <asp:TemplateField ShowHeader="False">
                            ...
                            <ItemTemplate>
                                ...
                                &nbsp;<asp:Button ID="Button2" runat="server" CausesValidation="False" CommandName="Delete" Text="刪除" OnClientClick="return confirm('確認刪除此筆資料??');"/>
                            </ItemTemplate>
                        </asp:TemplateField>
