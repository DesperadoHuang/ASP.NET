<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch9_Practice_1.aspx.cs" Inherits="ch9_Practice_1" %>
        ...
        <div>
            ...
            <asp:GridView ID="gridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="序號" DataSourceID="accessDataSource" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:CommandField ButtonType="Image" CancelImageUrl="~/Images/cancel.gif" DeleteImageUrl="~/Images/delete.gif" EditImageUrl="~/Images/edit.gif" SelectImageUrl="~/Images/select.gif" ShowDeleteButton="True" ShowEditButton="True" ShowSelectButton="True" UpdateImageUrl="~/Images/save.gif" UpdateText="儲存" />
                </Columns>
