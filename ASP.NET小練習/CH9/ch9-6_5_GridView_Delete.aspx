<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ch9-6_5_GridView_Delete.aspx.cs" Inherits="ch9_6_5_GridView_Delete" %>
                ...
                <Columns>
                    <asp:TemplateField ShowHeader="False">
                        ...
                        <ItemTemplate>
                            ...
                            &nbsp;<asp:Button ID="Button2" runat="server" CausesValidation="False" CommandName="Delete" Text="刪除" OnClientClick="return confirm('確定刪除此筆紀錄??');" />
                        </ItemTemplate>
                    </asp:TemplateField>
