    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="Panel1" runat="server" Width="320px">
                <asp:Calendar ID="calendar1" runat="server" Width="320px" ></asp:Calendar>
                ...
                終點日期：</asp:Label><asp:TextBox ID="textbox_EndDate" runat="server" ReadOnly="True"  ></asp:TextBox><asp:Button ID="bt_End" runat="server" Text="訖" OnClick="bt_End_Click" /><br />
